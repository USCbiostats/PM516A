...
The [Weekly Content](content.md) page contains information on pre- and in-class activities. While there are usually no submission requirements for pre-class content, it does serve to prepare students for activities in the live session. 
